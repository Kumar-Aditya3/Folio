...
Rules 1–12 of the main spec apply unchanged. This document adds §12 rules, which are
...
- Cover of the most recently opened in-progress book at `heroCoverMin` (≥120 dp)
...
`listCoverMin` (≥64 dp) with progress rings, capped at 3 as today. Excludes the hero book so
...
logic: hidden below 2 candidates.
...
| **B — Home** | §12.4 in full, including Home's own sparkline | 1.2.0 |
