...
/**
 * Protobuf backup models wire-compatible with Mihon/Tachiyomi `.backup` files.
 * Field numbers and types mirror Mihon's `eu.kanade.tachiyomi.data.backup.models`
 * so backups can be imported from and restored into either app.
 */
