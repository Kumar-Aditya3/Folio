...
inline fun <reified T> Response.parseAs(json: Json = defaultParseJson): T {
    return decodeFromJsonResponse(serializer(), this, json)
}

val defaultParseJson: Json = Json { ignoreUnknownKeys = true }
...
fun <T> decodeFromJsonResponse(
    ...
    return response.body.string().let { json.decodeFromString(deserializer, it) }
}
